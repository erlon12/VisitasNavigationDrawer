...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cidade) {
            FragCidade fragCidade = new FragCidade();
            getSupportFragmentManager().beginTransaction().replace(R.id.conteudo_fragment,fragCidade).commit();

        } else if (id == R.id.nav_estabelecimento) {
